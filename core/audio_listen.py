...
NO_AUDIO_TIMEOUT = 20.0  # чуть больше, чем PreviewPanel ждёт "Нет сигнала" (15с) — живой HLS-старт (реконнект +
# буферизация первого сегмента) на некоторых CDN реально занимает 13-16с, замерено напрямую
